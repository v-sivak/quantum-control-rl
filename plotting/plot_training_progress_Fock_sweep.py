...
root_dir = r'E:\data\gkp_sims\PPO\examples\Fock_states_sweep_angle_phase_2'
...
figname = r'E:\VladGoogleDrive\Qulab\GKP\paper\figs\Fock_prep_sweep_angle_phase_v2' # where to save
