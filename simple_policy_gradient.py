...
sigma = {s : tf.Variable(0.25, name='sigma_'+s) for s in actions}
baseline = tf.Variable(0.0, name='baseline')

# TODO: for PPO need to do 20 policy steps per epoch 
