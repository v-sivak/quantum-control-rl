...
class QuantumCircuit(OscillatorQubit, TFEnvironmentQuantumControl):
    ...
    def _control_circuit_spec(self):
        spec = {'beta_even'  : specs.TensorSpec(shape=[4,2], dtype=tf.float32),
                'beta_odd'  : specs.TensorSpec(shape=[4,2], dtype=tf.float32),
                'phi_even'   : specs.TensorSpec(shape=[4,2], dtype=tf.float32),
                'phi_odd'   : specs.TensorSpec(shape=[4,2], dtype=tf.float32),
                'echo_pulse_even'  : specs.TensorSpec(shape=[3,2], dtype=tf.float32),
                'echo_pulse_odd'  : specs.TensorSpec(shape=[3,2], dtype=tf.float32),
                'cavity_phase' : specs.TensorSpec(shape=[2], dtype=tf.float32),
                'Kerr_drive_amp' : specs.TensorSpec(shape=[2], dtype=tf.float32),
                'alpha_correction_even' : specs.TensorSpec(shape=[3,2], dtype=tf.float32),
                'alpha_correction_odd' : specs.TensorSpec(shape=[3,2], dtype=tf.float32),
                'qb_detune' : specs.TensorSpec(shape=[1], dtype=tf.float32),
                'qb_drag' : specs.TensorSpec(shape=[1], dtype=tf.float32),
                'cavity_detune' : specs.TensorSpec(shape=[1], dtype=tf.float32),
                'reset_pulse' : specs.TensorSpec(shape=[2], dtype=tf.float32)}
        return spec
