...
root_dir = r'E:\data\gkp_sims\PPO\ECD\EXP_Vlad\Z_gate\run_2'
...
reward_kwargs = {
    ...
    'epoch_type' : 'training',
    'N_msmt' : 30,
    'stabilizer_amplitudes' : [sqrt(pi/2), sqrt(pi/2), 1j*sqrt(pi/2), 1j*sqrt(pi/2)],
...
action_script = 'ECDC_residuals_GKP_Z_gate'
