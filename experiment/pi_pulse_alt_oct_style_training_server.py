...
root_dir = r'D:\rl_data\exp_training\pi_pulse_alt_oct_style_1'
...
action_script = {
  'pulse_val_real' : [[init_pulse_real[ii]] for ii in range(n_array_vals)], # shape=[n_array_vals]
  'pulse_val_imag' : [[init_pulse_imag[ii]] for ii in range(n_array_vals)]
  }

action_spec = {
  'pulse_val_real' : specs.TensorSpec(shape=[1], dtype=tf.float32),
  'pulse_val_imag' : specs.TensorSpec(shape=[1], dtype=tf.float32)
  }
