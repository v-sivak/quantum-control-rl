# -*- coding: utf-8 -*-
"""
Created on Wed Oct 20 17:26:12 2021
"""
import os
...
root_dir = r'E:\data\gkp_sims\PPO\ECD\EXP_Vlad\GKP_logical_readout_X\run_2'
...
reward_kwargs = {
    ...
    'stabilizer_signs' : [-1, 1], # by convention, first one will be |+X> state and second |-X>
    'penalty_coeff' : 0.0}
...
reward_kwargs_eval = {
    ...
    'N_msmt' : 300,
    'stabilizer_amplitudes' : [sqrt(pi/2), sqrt(pi/2)],
    'stabilizer_signs' : [-1, 1],
    'penalty_coeff' : 0.0}

# Params for action wrapper
action_script = 'ECD_control_residuals_logical_X_readout'
